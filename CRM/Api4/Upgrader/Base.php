 ...
 *
 * @method $this uninstall()
 * @method $this install()
 * @method $this postInstall()
 * @method $this enable()
 * @method $this disable()
 */
class CRM_Api4_Upgrader_Base {
	 ...
	 *
	 * @code
	 * CRM_Api4_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1',
	 * 'arg2');
	 * @endcode
	 */
	 ...
	 *   the CustomData XML file path (relative to
	 ...
	 *
	 * @param string $relativePath
	 *   the SQL file path (relative to this
	 *   extension's dir)
	 *
	...
	public function executeSqlTemplate($tplFile) {
		...
		$tplFile = CRM_Utils_File::isAbsolute($tplFile) ? $tplFile
	  : $this->extensionDir.DIRECTORY_SEPARATOR.$tplFile;
	...
	public function addTask($title) {
		...
		$callback = [\get_class($this), '_queueAdapter'];
		$task = new CRM_Queue_Task($callback, $args, $title);
	...
	public function getCurrentRevision() {
		$revision
	  = CRM_Core_BAO_Extension::getSchemaVersion($this->extensionName);
		if (!$revision) {
